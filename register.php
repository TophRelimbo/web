   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
   {
      ...
      else
      {
       ...
       $fname = $_POST["firstname"];
         ...
         $sql1 = "INSERT INTO info( firstname, lastname, middlename, address, contact_number)
    ...
    <div class="main-agileinfo">
      <div class="agileits-top">
        ...
        <form action="login.php" method="post">
         ...
         <input class="text" type="text" name="firstname" placeholder="Full Name" required="">
          <input class="text" type="text" name="lastname" placeholder="Last Name" required="">
           <input class="text" type="text" name="middlename" placeholder="Middle Name" required="">
            <input class="text" type="text" name="address" placeholder="Address" required="">
             <input class="text" type="text" name="contact_number" placeholder="Contact Number" required="">
...
<br>
          ...
          <input type="submit" name="btnReg" value="SIGNUP">
        </form>
